...
if (!prefersReducedMotion) {
  ...
  // ── Safety Watchdog ──
  // Ensures any [data-animate] element entering the viewport is NEVER left hidden at opacity: 0.
  // If GSAP Batch misses a fast scroll trigger, IntersectionObserver immediately forces graceful fade-in.
  ...
  document.querySelectorAll('[data-animate]:not(#hero *)').forEach((el) => safetyObserver.observe(el));
